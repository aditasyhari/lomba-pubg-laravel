                                        ...
                                        <div class="col-4 mb-2">
                                            <div class="border rounded p-2">
                                                ...
                                                <div class="media flex-column flex-md-row">
                                                    <img src="{{ asset('images/default.jpg') }}" id="blog-feature-image" class="rounded mr-2 mb-1 mb-md-0" width="130" height="100" alt="thumbnail" />
                                                    <div class="media-body">
                                                ...
                                                <div class="media flex-column flex-md-row">
                                                    <div class="media-body">
                                                        ...
                                                        <div class="d-inline-block">
                                                            <div class="form-group mb-0">
                                                                <div class="custom-file">
                                                                    <input type="file" class="custom-file-input" id="blogCustomFile" name="file" accept="image/*" required/>
